...
async def main(loop):
    ...
    routing_key = "healthcare.flow.*.started"    
    ...
    message = b"{\"topic\":\"healthcare.flow.*.started\",\"body\":{\"sessionId\":\"20210127161059.78fa38b6d1d83131bb\",\"response\":[{\"destination_id\":\"boberdoo-o65\",\"output\":{\"response\":{\"status\":\"Matched\",\"lead_id\":\"58258610\"}},\"status\":\"success\"}]},\"content_type\":\"\",\"exchange\":\"kraken\",\"received\":1611764117}"
